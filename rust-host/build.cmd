...
set MIDDLEWARE_COMPONENT=..\Adder\bin\Debug\net8.0\wasi-wasm\native\Adder.component.wasm

wasm-tools compose -o target\wasm32-wasi\release\my_rust_app.composed.wasm target\wasm32-wasi\release\my_rust_app.component.wasm -d %MIDDLEWARE_COMPONENT%